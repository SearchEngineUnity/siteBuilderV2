...
import ThreeQuarterStars from './assets/ThreeQuarterStars';
...
import OneThreeQuarterStars from './assets/OneThreeQuarterStars';
...
function ProductCardRating({ rating }) {
  ...
  if (rating <= 0.124) {
    ...
    ImageRating = OneThreeQuarterStars;
